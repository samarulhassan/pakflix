...
<body>
    ...
    @include('navuser')
    <h1 class="featured">Your Playlist</h1>
    <hr>
            ...
            <li class="card radius">
                ...
                <div class="card-content">
                    <div class="card-content-inner">
                       <iframe class="d-block w-150"width="320" height="200" src="{{$playlistarray[$x]['url']}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
                <div class="card-footer card-title"><i>
                    
                </i>{{$playlistarray[$x]['title']}}</div>
