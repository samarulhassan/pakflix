...
<header>
    ...
    <div style="text-align: center">
      ...
      <a href="{{ url('Addtoplaylist_novel', $id) }}" class="playlist">Add to playlist
          <i class="fa fa-plus" style="font-size:14px"></i></a> <hr>
 ...
 <!-- <button class="add">Add to playlist <i class="fas fa-plus"></i></button> -->


    <h1 class="featured-novels">Suggestions</h1>
            ...
            <li class="card radius">
                ...
                <div class="card-content">
                    <div class="card-content-inner">
                        <iframe class="d-block w-150" 
                        width="310" height="200" src="{{$sugarray[$x]['url']}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
                <div class="card-footer card-title"><i>
                    
                </i>{{$sugarray[$x]['title']}}
                    <a href="{{ url('novelvideo', $sugarray[$x]['novelid']) }}" class="btn play">Play <i class="fa fa-play" style="font-size:14px"></i></a>
                </div>
            </li>
            <?php } ?>
