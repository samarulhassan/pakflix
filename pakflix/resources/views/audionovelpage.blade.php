...
<header>
    <nav class="navbar navbar-expand-lg navbar-light back">
        ...
        <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
            ...
            <form class="d-flex" type="GET" method="get" action= "{{url('/search_novel')}}">
                <input class="form-control me-2"style="background-color: #3e3a41;
                color:white; border:none;" 
                type="search" placeholder="Search" aria-label="Search" name="query_novel"><i class="fas fa-search"></i>
              </form>
...
<h1 class="featured-novels">Listen Your Favourite Audio Novels</h1>
    <hr>
            ...
            <li class="card radius">
                ...
                <div class="card-content">
                    <div class="card-content-inner">
                        <iframe class="d-block w-150"width="330" height="200" src="<?php echo $novel->url; ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
                <div class="card-footer card-title text-align">
                    
                 {{$novel->title}}
            <!-- <a href="{{ url('novelvideo', $novel->novelid) }}" class="fas fa-play-circle">
                 </a> -->
                 <a href="{{ url('novelvideo', $novel->novelid) }}"
                  class="play btn">Play <i class="fa fa-play" style="font-size:14px"></i></a>
